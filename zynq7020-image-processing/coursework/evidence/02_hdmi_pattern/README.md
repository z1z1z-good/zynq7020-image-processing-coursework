...
| 文件 | 内容 |
| --- | --- |
| `exp01_expected_pattern.png` | 从 Verilog ROM 逐像素生成并叠加蓝色边框的 1280x720 现场对照图 |
