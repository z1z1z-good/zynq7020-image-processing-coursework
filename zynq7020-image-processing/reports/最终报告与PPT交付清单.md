...
| 5 | 第二周综合扩展仿真截图、波形截图或软件验证结果 | [zynq7020-image-processing/coursework/evidence/照片证明/大拓展最终验收视频截图/*.png](../coursework/evidence/照片证明/大拓展最终验收视频截图/)、[zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt](../coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt)、[zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_scaling_matrix.txt](../coursework/evidence/07_input_scaling_extension/ext_scaling_matrix.txt) |
...
| 7 | 创新点 | 必须 | 不改硬件，PC 端统一适配；三种 fit；两种处理尺寸；保持协议不变 | [zynq7020-image-processing/coursework/evidence/照片证明/大拓展最终验收视频截图/strech_128x72.png](../coursework/evidence/照片证明/大拓展最终验收视频截图/strech_128x72.png) 等最终验收截图 |
| 8 | 实现原理 | 必须 | `prepare_frame -> build_frame_packet -> UART -> sobel_05` | 简图 + 帧头 `55 aa 80 00 48 00 18` |
| 9 | 仿真/软件验证 | 必须 | 11/11 测试通过；18 组矩阵；包长和帧头不变 | [zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt](../coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt) 摘要、[zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_scaling_matrix.txt](../coursework/evidence/07_input_scaling_extension/ext_scaling_matrix.txt) 摘要 |
| 10 | 上板展示结果 | 必须 | 三种 fit 策略和两种处理尺寸最终效果 | [zynq7020-image-processing/coursework/evidence/照片证明/大拓展最终验收视频截图/](../coursework/evidence/照片证明/大拓展最终验收视频截图/) 选 5 张 |
...
大拓展相关图片优先使用 [zynq7020-image-processing/coursework/evidence/照片证明/大拓展最终验收视频截图/](../coursework/evidence/照片证明/大拓展最终验收视频截图/) 下的最终验收截图。[zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/](../coursework/evidence/07_input_scaling_extension/) 下的图片和日志作为软件验证辅助材料。
...
4. 若需要正式提交最终报告，确认 [zynq7020-image-processing/reports/最终报告.md](./最终报告.md)、[zynq7020-image-processing/reports/最终报告与PPT交付清单.md](./最终报告与PPT交付清单.md)、[zynq7020-image-processing/coursework/evidence/照片证明/大拓展最终验收视频截图/*](../coursework/evidence/照片证明/大拓展最终验收视频截图/) 和 [zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/*](../coursework/evidence/07_input_scaling_extension/) 已纳入 Git。
...
建议重画流程图；也可放 [zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_cli_help.txt](../coursework/evidence/07_input_scaling_extension/ext_cli_help.txt) 中参数截图，但优先用流程图。
...
- [zynq7020-image-processing/coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt](../coursework/evidence/07_input_scaling_extension/ext_offline_tests.txt) 的测试结果可截图或手工做成表格
