...
set src_dir [file join $script_dir sobel_03_uart_hdmi.srcs sources_1]
...
set xdc_dir [file join $script_dir sobel_03_uart_hdmi.srcs constrs_1 new]
...
create_project -force exp03_build $build_dir -part xc7z020clg400-2
set_property target_language Verilog [current_project]

# ---------- Block design：PS7 + SmartConnect + AXI BRAM Controller + Block Memory ----------
# 在隔离 build 工程内全新重建 BD，不触碰仓库中已提交的 2017.4 BD。
...
puts "EXP03_STAGE=synthesis"
synth_design -top top -part xc7z020clg400-2
report_utilization -file [file join $evidence_dir exp03_utilization.txt]

puts "EXP03_STAGE=implementation"
opt_design
place_design
phys_opt_design
route_design
...
report_timing_summary -delay_type min_max -report_unconstrained \
    ...
    -file [file join $evidence_dir exp03_timing_summary.txt]
report_drc -file [file join $evidence_dir exp03_drc.txt]

set bit_file [file join $build_dir top.bit]
puts "EXP03_STAGE=bitstream"
write_bitstream -force $bit_file
puts "EXP03_BITSTREAM=$bit_file"

# 导出硬件平台 XSA（含地址映射的硬件规格），供 M5 的 Vitis PS 程序编译。
...
puts "EXP03_XSA=$xsa_file"
puts "EXP03_BUILD=passed"
